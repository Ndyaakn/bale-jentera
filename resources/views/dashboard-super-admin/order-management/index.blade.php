...
@section('content-header')
    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block">Manajemen order</h3>
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/home">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Manajemen order
                    </li>
                </ol>
            </div>
        </div>
                            ...
                            @foreach($order as $item)
                                <tr>
                                    ...
                                    <td class="text-capitalize">
                                        @if($item->order_category == 'dine in')
...
@section('script')
    <script>
        $(document).on("click", ".deleteOrderButton", function()
        {
            ...
            $("#deleteOrderForm").attr("action", "{{ route('jurnal.index') }}/" + id)
